...
from BaseRobot.Motors import OmniWheelMotorModule, default_motor_configuration
...
class Base_Robot:
    def __init__(self, Simulator=False, Debug=False):
        ...
        self.motors = OmniWheelMotorModule(
            motor_configuration=default_motor_configuration, debug=Debug
        )
    ...
    def GenerateSounds(self):
        self.sound.NewPattern(
            "Boot", [("C4", "q"), ("E4", "q"), ("G4", "q")], tempo=240
        )

        self.sound.NewPattern(
            "Stop", [("G4", "q"), ("E4", "q"), ("C4", "q")], tempo=240
        )
